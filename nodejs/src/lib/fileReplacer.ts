 ...
 */
export function isInIgnoreFile(path: string, ignoreFilePath: string = '.忽略', extName: string = 'orz'): Promise < boolean > {
 ...
 */
export function translaterFileTreeWithExtname(path: string,
